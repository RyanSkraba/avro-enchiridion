...
/** Test reading data with a schema that has evolved by reordering fields. */
public class EvolveReorderFieldsTest {

  /** The same as the original schema but with the field order changed field. */
  ...
  public void testRenameAFieldFromARecord() {
    ...
    assertThat(recordV2.get(1), is(1L));
  }
}
