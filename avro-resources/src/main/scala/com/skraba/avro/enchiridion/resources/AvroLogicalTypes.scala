...
object AvroLogicalTypes {
  ...
  lazy val TimestampMillis: JsObject = Json.obj("type" -> "long", "logicalType" -> "timestamp-millis")
  lazy val TimestampMicros: JsObject = Json.obj("type" -> "long", "logicalType" -> "timestamp-micros")
  lazy val Date: JsObject = Json.obj("type" -> "int", "logicalType" -> "date")
  lazy val TimeMillis: JsObject = Json.obj("type" -> "int", "logicalType" -> "time-millis")
  lazy val TimeMicros: JsObject = Json.obj("type" -> "long", "logicalType" -> "time-micros")
